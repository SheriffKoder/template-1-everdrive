...
const SectionfiveWrapperDesktop = () => {
  ...
  return (
    ...
    px-[5rem] relative'>
        ...
        <h1 className='text-white w-[300px] lg:w-[600px] localfont2 text-[40px] lg:text-[60px] font-bold
        ...
        flex flex-col gap-0 items-start justify-start'>
            ...
            */}
            ...
            <SmoothScrollButton text="schedule a test drive" sectionId="section-one" backgroundColor="#03684B" textColor="#ffffff" className="relative text-sm lg:text-[30px] mt-5 ml-10" />
            </div>
...
export default SectionfiveWrapperDesktop