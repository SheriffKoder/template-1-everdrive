  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-8 p-4 bg-background">
      ...
      <div className="container mx-auto flex flex-wrap items-center justify-center gap-4">
        <div className="h-64 w-full sm:w-52 bg-blue-500 text-white custom:text-primary p-4 rounded-lg flex flex-col gap-4">
        ...
        <div className="h-64 w-full sm:w-52 bg-primary text-white dark:text-black p-4 rounded-lg flex flex-col gap-4">
